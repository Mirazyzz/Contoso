...
{
    public partial class StudentSubjectEnrollment : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Fee = table.Column<decimal>(type: "TEXT", nullable: false, defaultValue: 100m),
                    TotalHours = table.Column<int>(type: "INTEGER", nullable: true, defaultValue: 40)
                },
                constraints: table =>
                {
